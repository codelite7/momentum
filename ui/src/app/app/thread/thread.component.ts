...
export class ThreadComponent {
  ...
  async sendMessage(){
    try {
      ...
      if (newThreadMessage) {
        this.messages = await this.messageService.threadMessages({userId: '', threadId: this.thread!.id, first: 50, orderBy: [{field: MessageOrderField.CreatedAt, direction: OrderDirection.Asc}]})
