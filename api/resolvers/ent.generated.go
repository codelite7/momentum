...
func (ec *executionContext) unmarshalInputCreateBookmarkInput(ctx context.Context, obj interface{}) (ent.CreateBookmarkInput, error) {
	...
	fieldsInOrder := [...]string{"userID", "threadID", "messageID", "responseID"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputCreateMessageInput(ctx context.Context, obj interface{}) (ent.CreateMessageInput, error) {
	...
	fieldsInOrder := [...]string{"content", "sentByID", "threadID", "bookmarkIDs", "responseID"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputCreateResponseInput(ctx context.Context, obj interface{}) (ent.CreateResponseInput, error) {
	...
	fieldsInOrder := [...]string{"content", "sentByID", "messageID", "bookmarkIDs"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputCreateUserInput(ctx context.Context, obj interface{}) (ent.CreateUserInput, error) {
	...
	fieldsInOrder := [...]string{"email", "bookmarkIDs", "threadIDs", "messageIDs"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputUpdateBookmarkInput(ctx context.Context, obj interface{}) (ent.UpdateBookmarkInput, error) {
	...
	fieldsInOrder := [...]string{"userID", "threadID", "clearThread", "messageID", "clearMessage", "responseID", "clearResponse"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputUpdateMessageInput(ctx context.Context, obj interface{}) (ent.UpdateMessageInput, error) {
	...
	fieldsInOrder := [...]string{"content", "sentByID", "threadID", "addBookmarkIDs", "removeBookmarkIDs", "clearBookmarks", "responseID", "clearResponse"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputUpdateResponseInput(ctx context.Context, obj interface{}) (ent.UpdateResponseInput, error) {
	...
	fieldsInOrder := [...]string{"content", "clearContent", "sentByID", "messageID", "addBookmarkIDs", "removeBookmarkIDs", "clearBookmarks"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputUpdateUserInput(ctx context.Context, obj interface{}) (ent.UpdateUserInput, error) {
	...
	fieldsInOrder := [...]string{"email", "addBookmarkIDs", "removeBookmarkIDs", "clearBookmarks", "addThreadIDs", "removeThreadIDs", "clearThreads", "addMessageIDs", "removeMessageIDs", "clearMessages"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
