...
var schemaGraph = func() *sqlgraph.Schema {
	...
	graph.Nodes[2] = &sqlgraph.Node{
		...
		Fields: map[string]*sqlgraph.FieldSpec{
			...
			message.FieldMessageType: {Type: field.TypeEnum, Column: message.FieldMessageType},
		},
	}
	...
	graph.Nodes[4] = &sqlgraph.Node{
		...
		Fields: map[string]*sqlgraph.FieldSpec{
			...
			thread.FieldProvider:     {Type: field.TypeEnum, Column: thread.FieldProvider},
		},
	}
...
func (f *MessageFilter) WhereMessageType(p entql.StringP) {
	f.Where(p.Field(message.FieldMessageType))
}
...
func (f *MessageFilter) WhereHasChild() {
...
func (f *MessageFilter) WhereHasChildWith(preds ...predicate.Thread) {
...
// WhereProvider applies the entql string predicate on the provider field.
func (f *ThreadFilter) WhereProvider(p entql.StringP) {
	f.Where(p.Field(thread.FieldProvider))
}
...
func (f *ThreadFilter) WhereHasParentWith(preds ...predicate.Message) {
